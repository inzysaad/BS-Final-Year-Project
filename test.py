...
# ############################### Load Trained model
pickle_in=open("traffic_sign_50.p","rb")
model=pickle.load(pickle_in)


# ######################################## pre-processing for detect signs in  image.
...
# ###################################### Get the class name using class id detected by the model
...
if __name__ == "__main__":
    ...
    while (1):
        ...
        cv2.imshow("Traffic Sign", img_bbx)

    # Lane detection

        image = cv2.resize(orig_frame, (640, 480))
